...
class FollowContentN extends StatelessWidget {
  @override
...
class FollowContent extends StatefulWidget {
  @override
  _FollowContent createState() => _FollowContent();
}

class _FollowContent extends State<FollowContent> {

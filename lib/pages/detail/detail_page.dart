...
import 'package:commuitynapp/pages/detail/detail_title_widget.dart';
import 'package:commuitynapp/util/pick_img_main_color.dart';
import 'package:commuitynapp/constant/constant.dart';
import 'package:commuitynapp/pages/detail/score_start.dart';
    ...
    return Hero(
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            onTap: () {
              AppRouter.Router .push(context, AppRouter.Router .personDetailPage,
              ...
              itemBuilder: (BuildContext context, int index) {
                if (index == 0 && _movieDetailBean.trailers.isNotEmpty) {
                  return GestureDetector(
                    ...
                    onTap: () {
                      AppRouter.Router.push (context, AppRouter.Router.playListPage,
      ...
      return SliverList(
        ...
        if (index == 0) {
          ...
          return GestureDetector(
            ...
            onTap: () {
              AppRouter.Router.push(context, bean.author.alt, {'title': '个人主页'});
            },
          );
        }
      }, childCount: allCount));
    ...
    return Hero(
      ...
      child: Material(
        ...
        child: InkWell(
          child: widget,
          onTap: () {
            AnimalPhoto.show(context,0, imgUrl);
          },
        ),
      ),
    );

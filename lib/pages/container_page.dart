import 'package:commuitynapp/pages/follow/follow_content.dart';
import 'package:commuitynapp/pages/message/message.dart';
import 'package:commuitynapp/pages/person/person_detail_page.dart';
import 'package:flutter/material.dart';
import 'package:commuitynapp/pages/group/group_page.dart';
import 'package:commuitynapp/pages/movie/book_audio_video_page.dart';
import 'package:commuitynapp/pages/home/home_page.dart';
import 'package:commuitynapp/pages/person/person_center_page.dart';
import 'package:commuitynapp/pages/shop_page.dart';
...
class _ContainerPageState extends State<ContainerPage> {
  ...
  //final defaultItemColor = Colors.yellow;
  final itemNames = [
    _Item('首页', 'assets/images/ic_tab_home_active.png',
        'assets/images/ic_tab_home_normal.png'),
    _Item('频道', 'assets/images/ic_tab_subject_active.png',
        'assets/images/ic_tab_subject_normal.png'),
    _Item('消息', 'assets/images/ic_tab_group_active.png',

...
class SingleCommentEntity{
  ...
  SingleCommentEntity.fromMap(Map<String, dynamic> json) {
		discId = json['discId'];
		discDid = json['discDid'];
		atUsers = json['atUsers'];
    usrNickname = json['usrNickname'];
    userHead = json['userHead'];
    discPid = json['discPid'];
    discUid = json['discUid'];
    discAtUid = json['discAtUid'];
    discMessage = json['discMessage'];
    discCreatime = json['discCreatime'];
	}

	Map<String, dynamic> toJson() {
		final Map<String, dynamic> data = new Map<String, dynamic>();
		data['discId'] = this.discId;
		data['discDid'] = this.discDid;
		data['atUsers'] = this.atUsers;
    data['usrNickname'] = this.usrNickname;
		data['userHead'] = this.userHead;
		data['discPid'] = this.discPid;
    data['discUid'] = this.discUid;
		data['discAtUid'] = this.discAtUid;
		data['discMessage'] = this.discMessage;
    data['discCreatime'] = this.discCreatime;
		return data;
	}
}
